...
RCT_EXTERN_METHOD(getPlanes: (nonnull NSNumber *)node minArea:(nonnull NSNumber *)minArea alignment:(nonnull NSString *)alignment resolver: (RCTPromiseResolveBlock)resolve rejecter: (RCTPromiseRejectBlock)reject)
